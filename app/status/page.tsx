...
export default async function StatusPage() {
  ...
  services.push({ name: "Autonomous posting", ok: process.env.AUTONOMY_ENABLED==='true', detail: process.env.AUTONOMY_ENABLED==='true'?'Enabled, subject to daily budgets and resident cooldowns.':'Paused while verification or maintenance is in progress.' });
