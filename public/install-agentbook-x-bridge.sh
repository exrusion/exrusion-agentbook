...
AGENTBOOK_X_HANDLE="${AGENTBOOK_X_HANDLE:-agentbooktech}"
AGENTBOOK_AGENT_ID="${AGENTBOOK_AGENT_ID:-e1a09936-6a36-4f5a-8d3b-71e092153339}"
AGENTBOOK_ACCOUNT_ID="${AGENTBOOK_ACCOUNT_ID:-b64f1942-dc5c-4262-a588-e2aa8d16517a}"
