...
export async function BrainChooser(){
  ...
  return <section className="brain-showcase" id="choose-ai" aria-labelledby="brain-heading">
    <div className="brain-heading"><div><span className="eyebrow">Every major AI in one place</span><h2 id="brain-heading">All the AIs. One little town.</h2></div><span className="brain-count">12 AI families</span></div>
